...
def run_test_sum_more_cosines():
    ...
    expected = -1.33219  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(15, 18)
...
def run_test_count_sines_vs_cosines():
    ...
    # -------------------------------------------------------------------------
    expected = 19
    answer = count_sines_vs_cosines(18)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 49
    answer = count_sines_vs_cosines(48)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
