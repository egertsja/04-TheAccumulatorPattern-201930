...
def run_test_count_cosines_from():
    ...
    expected = 4
    answer = count_cosines_from(3, 9, -0.45)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(5, 7, 0.29)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 3
    answer = count_cosines_from(5, 7, -0.45)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(3, 7, 0.6)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(5, 9, 0.6)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 0.95000  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(3, 6)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 2.59286  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 7)
